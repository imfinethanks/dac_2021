...
wdir = '/home/sxl/ultra_net_all/weights_32_3fz1_前50只用obj_4b_全' + os.sep  # weights dir
last = wdir + 'last.pt'
best = wdir + 'best.pt'
test_best = wdir + 'test_best.pt'
results_file = 'results_32_3fz1_前50只用obj_4b_全.txt'
os.makedirs(wdir, exist_ok=True)  
tb_patch='Result_32_3fz1_前50只用obj_4b_全'
...
def train():
    ...
    train_path = '/home/sxl/ultra_net_all/files_all_txt.txt'
    test_path = '/home/sxl/ultra_net_all/files_all_txt.txt'
    nc = 1 
    ...
    dataset = LoadImagesAndLabels_file(train_path, img_size, batch_size,
                                  augment=True,
                                  hyp=hyp,  # augmentation hyperparameters
                                  rect=opt.rect,  # rectangular training
                                  cache_images=opt.cache_images,
    ...
    # Testloader
    testloader = torch.utils.data.DataLoader(LoadImagesAndLabels_file(test_path, img_size_test, batch_size * 2,
                                                                 hyp=hyp,
                                                                 rect=False,
                                                                 cache_images=opt.cache_images,
                                                                 single_cls=opt.single_cls),
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        pbar = tqdm(enumerate(dataloader), total=nb,ncols=0)  # progress bar
...
if __name__ == '__main__':
    ...
    # tb_writer = SummaryWriter('Result_旁路方案1')
    ...
    if not opt.evolve:  # Train normally
        try:
            ...
            tb_writer = SummaryWriter(tb_patch)
        except:
            pass
